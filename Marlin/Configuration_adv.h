 ...
 */
#define E0_AUTO_FAN_PIN FAN1_PIN // FAN0
...
// FIXME: these go in the wrong direction to expected? rams hotend into frame

  // Define positions for probing points, use the hotend as reference not the sensor.
  #define TRAMMING_POINT_XY {{25,25},{25, 170}, {170,25},{170,170}} 

  // Define positions names for probing points.
  #define TRAMMING_POINT_NAME_1 "Front-left"
  #define TRAMMING_POINT_NAME_2 "Rear-left"
  #define TRAMMING_POINT_NAME_3 "Front-right"
  #define TRAMMING_POINT_NAME_4 "Rear-right"
 ...
 */
  ...
  #define INTERPOLATE       true  // Interpolate X/Y/Z_MICROx_STEPS to 256
